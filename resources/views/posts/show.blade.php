    ...
    <section class="px-6 py-8">
        ...
        <main class="max-w-6xl mx-auto mt-5 lg:mt-20 space-y-6">
            ...
            <section class="col-span-8 col-start-5 mt-10 space-y-6">
                @auth
                <form method="POST" action="/posts/{{ $post->slug }}/comments" class=" border border-xl">
                    @csrf
                    ...
                    <div class="justify-end flex border-t border-gray-200">
                        <button type="submit" class="bg-blue-500 text-white font-semibold text-xs rounded-2xl py-3 px-9">Post</button>
                    </div>
                </form>
                @else
